...
public class PostagemController {
	 ...
	 * 
	 * Portuguese:O método POST HTTP é usado para criar um recurso e uma anotação @PostMapping para mapear solicitações HTTP POST em métodos de manipulador específicos.
	 * @param postagem
	 * @return
	 */
	@PostMapping
